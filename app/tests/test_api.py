...
class TestRestApi:
    ...
    async def test_create_menu(self, async_client: AsyncClient):
        ...
        response = await async_client.post(self.LOCAL_URL.format("menus/"), json=data)
    ...
    async def test_target_menu(self, async_client: AsyncClient):
        response = await async_client.get(self.LOCAL_URL.format(f"menus/{MenuTempStorage.id}"))
        response_json = response.json()
    ...
    async def test_update_menu(self, async_client: AsyncClient):
        ...
        response = await async_client.patch(self.LOCAL_URL.format(f"menus/{MenuTempStorage.id}"), json=data)
        response_json = response.json()
    ...
    async def test_create_submenu(self, async_client: AsyncClient):
        ...
        response = await async_client.post(self.LOCAL_URL.format(f"menus/{MenuTempStorage.id}/submenus/"), json=data)
        response_json = response.json()
    ...
    async def test_update_submenu(self, async_client: AsyncClient):
        ...
        response = await async_client.patch(self.LOCAL_URL.format(
            f"menus/{MenuTempStorage.id}/submenus/{SubmenuTempStorage.id}"
        ), json=data)
        response_json = response.json()
    ...
    async def test_create_dish(self, async_client: AsyncClient):
        ...
        response = await async_client.post(self.LOCAL_URL.format(
            f"menus/{MenuTempStorage.id}/submenus/{SubmenuTempStorage.id}/dishes/"
        ), json=data)
        response_json = response.json()
    ...
    async def test_delete_submenu(self, async_client: AsyncClient):
        response = await async_client.delete(self.LOCAL_URL.format(
            f"menus/{MenuTempStorage.id}/submenus/{SubmenuTempStorage.id}")
        )
    ...
    async def test_menu_counter_after_delete_submenu(self, async_client: AsyncClient):
        response = await async_client.get(self.LOCAL_URL.format(f"menus/{MenuTempStorage.id}"))
        response_json = response.json()
    ...
    async def test_delete_menu(self, async_client: AsyncClient):
        response = await async_client.delete(self.LOCAL_URL.format(f"menus/{MenuTempStorage.id}"))
