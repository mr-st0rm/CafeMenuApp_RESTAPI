...
@menu_router.get("/", tags=["Menu"], description=MenuApiDocs.GET_LIST, response_model=typing.List[res_model.Menu])
...
@menu_router.post("/", tags=["Menu"], description=MenuApiDocs.POST_CREATE, response_model=res_model.Menu, status_code=201)
...
@menu_router.get("/{menu_id}", tags=["Menu"], description=MenuApiDocs.GET_DETAIL, response_model=res_model.Menu)
...
@menu_router.patch("/{menu_id}", tags=["Menu"], description=MenuApiDocs.PATCH_UPDATE, response_model=res_model.Menu)
...
@menu_router.delete("/{menu_id}", tags=["Menu"], description=MenuApiDocs.DELETE)
